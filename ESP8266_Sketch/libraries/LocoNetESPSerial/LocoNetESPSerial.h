...
#ifndef LocoNetESPSerial_h
#define LocoNetESPSerial_h
...
#define lnAvailable 2

class LocoNetESPSerial : public Stream
{
public:
   LocoNetESPSerial(int receivePin, int transmitPin, bool inverse_logic = false, unsigned int buffSize = 64);
   ~LocoNetESPSerial();
